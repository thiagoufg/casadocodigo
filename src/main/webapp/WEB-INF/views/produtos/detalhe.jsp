...
<head>
	...
	<link href="//cdn.shopify.com/s/files/1/0155/7645/t/177/assets/produtos.css?10732338795638998506" rel="stylesheet" type="text/css"  media="all"  />
</head>
	...
	<article id="${produto.id}" itemscope itemtype="http://schema.org/Book">
			...
			<form:form action="${shoppingCartUrl}" method="post" class="container">
				...
				<ul id="variants" class="clearfix">
					<c:forEach items="${produto.precos}" var="preco">
						<li class="buy-option">
							<input type="radio" name="tipo" class="variant-radio" id="${produto.id}-${preco.tipo}"
		...
		<div class="container">
			...
			<section class="data produto-detail">
				...
				<p>
					Data de publicação: <span itemprop="paginas">${produto.dtLancamento}</span>
				</p>
