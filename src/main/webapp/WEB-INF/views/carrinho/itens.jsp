...
<body>
  ...
  <header id="layout-header">
	...
	<section class="container middle">
		  <h2 id="cart-title">Seu carrinho de compras (${carrinhoCompras.quantidade} })</h2>
		    ...
		    <table id="cart-table">
		      ...
		      <tbody>
		      	<c:forEach items="${carrinhoCompras.itens }" var="item"></c:forEach>
			      <tr>
			      ...
			      <tfoot>
			        <tr>
			          ...
			          <td class="numeric-cell">${carrinhoCompras.getTotal() }</td><td></td>
			        </tr>
			      </tfoot>
		    </table>
